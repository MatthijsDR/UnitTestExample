...
namespace UnitTestingExample.Tests
{
    ...
    public partial class StringUtilitiesTests
    {
        ...
        public void TestForTooFewWords()
        {
            ...
            // Assert
            result.Should().HaveCount(4); // result should have count equal to 4
        }
        ...
        public void TestForEmptySplitPlaces()
        {
            ...
            // Assert
            result.First().Should().Equals("test"); // the first item should be equivalent to "test"
        }
        ...
        public void TestOrderingWhenCountsAreEqual()
        {
            ...
            // Assert
            result.Should().Contain(expected).And.BeInAscendingOrder();// result should contain all items of expected in order
        }
    }
}
